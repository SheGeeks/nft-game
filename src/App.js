    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">🦅 Birdemic 🦅</p>
          <p className="sub-text">
            Where no bird has gone before...& survived.
          </p>
          {renderContent()}
        </div>
        <div className="footer-container">
          ...
          <a
            className="footer-text"
            href="https://www.behance.net/sandraristau"
            target="_blank"
            rel="noreferrer"
          >
            Image: Humblee Studio
          </a>{" "}
          {" // "}
          <a
            className="footer-text"
            href="https://shegeeks.net"
            target="_blank"
            rel="noreferrer"
          >
            Coded by Corvida
